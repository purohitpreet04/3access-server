...
export const getDocumentModule = async (type, id) => {
    try {
        ...
        // }
        if (['confidentiality_wavier_form', 'license_to_occupy', 'license_charge_payments', 'your_weekly_service_charge', "personal_details", "authorization_form", "fire_evacuation_procedure_for_all_residents", "missing_person_form"].includes(type)) {
